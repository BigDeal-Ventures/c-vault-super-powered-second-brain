...
function cVaultGuide(packs) {
  ...
  if (hasCmo) startItems.push('Read `CMO Skills Guide.md` for the overview, then `CMO Skills/Start Here.md`, `CMO Skills/Decision Guide.md`, and `CMO Skills/Playbooks.md` for real work.');
