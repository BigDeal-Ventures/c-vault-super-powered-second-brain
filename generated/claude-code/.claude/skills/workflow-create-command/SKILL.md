---
name: workflow-create-command
description: Use when the user asks to run the /create-command C-Vault workflow from the C-Vault Core pack. Create Command
---

# workflow-create-command

This skill wraps the C-Vault /create-command command so agents can route to it while the slash command remains available.
