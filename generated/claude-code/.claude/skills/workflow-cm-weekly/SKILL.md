---
name: workflow-cm-weekly
description: Use when the user asks to run the /cm-weekly C-Vault workflow from the CMO Skills pack. /cm:weekly — Weekly Marketing Review
---
