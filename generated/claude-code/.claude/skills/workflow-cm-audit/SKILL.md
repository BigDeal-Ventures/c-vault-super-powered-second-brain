---
name: workflow-cm-audit
description: Use when the user asks to run the /cm-audit C-Vault workflow from the CMO Skills pack. /cm:audit — Marketing Audit
---

# workflow-cm-audit

This skill wraps the C-Vault /cm-audit command so agents can route to it while the slash command remains available.
