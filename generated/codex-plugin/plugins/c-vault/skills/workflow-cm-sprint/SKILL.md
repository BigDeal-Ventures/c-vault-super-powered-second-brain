---
name: workflow-cm-sprint
description: Use when the user asks to run the /cm-sprint C-Vault workflow from the CMO Skills pack. /cm:sprint — Marketing Sprint Planning
---

# workflow-cm-sprint

This skill wraps the C-Vault /cm-sprint command so agents can route to it while the slash command remains available.
