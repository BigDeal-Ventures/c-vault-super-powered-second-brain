---
name: workflow-cm-research
description: Use when the user asks to run the /cm-research C-Vault workflow from the CMO Skills pack. /cm:research — Deep Market Research Workflow
---

# workflow-cm-research

This skill wraps the C-Vault /cm-research command so agents can route to it while the slash command remains available.
