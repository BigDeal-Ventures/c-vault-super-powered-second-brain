---
name: workflow-cm-email
description: Use when the user asks to run the /cm-email C-Vault workflow from the CMO Skills pack. /cm:email — Email Campaign Setup End-to-End
---

# workflow-cm-email

This skill wraps the C-Vault /cm-email command so agents can route to it while the slash command remains available.
