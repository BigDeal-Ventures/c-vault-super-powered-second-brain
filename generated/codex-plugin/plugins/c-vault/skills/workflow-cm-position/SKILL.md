---
name: workflow-cm-position
description: Use when the user asks to run the /cm-position C-Vault workflow from the CMO Skills pack. /cm:position — Full Positioning Workshop
---

# workflow-cm-position

This skill wraps the C-Vault /cm-position command so agents can route to it while the slash command remains available.
